...
public class Penguin extends GameObj{
	
	public static final String img_file = "PenguinAdvanceRetreat.png";
	public static final String img_file2 = "PenguinAttack1.png";
	...
	public Penguin(int courtWidth, int courtHeight) {
